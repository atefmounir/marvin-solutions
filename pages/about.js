...
export default function About(props) {
    ...
    return (
        <Grid container direction="column">
            <Head>
                <title key='title'>About Us - History & Teams | Arc Development</title>
                <meta
                    name='description'
                    key='description'
                    content='We provide the fastest, most modern, affordable, and aesthetic software design and development services in Egypt. Get it free estimate now.'/>
                <meta
                    property="og:title"
